    ...
    public void searchCheckInInfo(){
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("ticketList.txt"))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                System.out.println(name.equals(parts[1]));
                System.out.println(name + " " + parts[1]);
                System.out.println(departureDate.equals(parts[5]));
                System.out.println();

                if (reservationNum == target && name.equals(parts[1]) && departureDate.equals(parts[5])) {
